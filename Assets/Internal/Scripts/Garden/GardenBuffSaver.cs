...
public class GardenBuffSaver : MonoBehaviour
{
    ...
    public void LoadBuffs()
    {
        ...
        GlobalGarden.LevelsToSkipLevel = PlayerPrefs.GetInt(defaultPrefix + prefix + LevelToSkipLevelString, 0);
    ...
    public void SaveBuffs()
    {
        ...
        PlayerPrefs.SetInt(defaultPrefix + prefix + LevelToSkipLevelString, GlobalGarden.LevelsToSkipLevel);
